...
export const ClientsTable = ({ props }: any) => {
  ...
  return (
    <div className="py-10 px-5 w-full client-table bg-white p-5 rounded-md h-full">
      ...
      <div className="">
        <div className="w-full  px-3 py-4 mb-5 grid grid-cols-4 rounded-[8px] text-[#032282] rounded-b-none border-b-2 border border-x-0 border-t-0 border-[#032282] bg-sky-100 font-semibold text-[14px]">
          <span>Name</span>
          <span>Email</span>
          <span>Phone</span>
          <span> Residential Address</span>
